...
**เทมเพลตอีเมลเริ่มต้นของ Supabase มีแต่ลิงก์ ไม่มีรหัส** จึงต้องแก้หนึ่งที่:

1. เปิด Supabase Dashboard → **Authentication** → **Emails** (บางเวอร์ชันอยู่ใต้
   **Email Templates**)
2. เลือกแท็บ **Reset Password**
3. เพิ่มบรรทัดนี้ลงในเนื้อหาอีเมล
...
เก็บลิงก์เดิมไว้ด้วยก็ได้ ไม่ต้องลบ — ผู้ใช้ที่เปิดอีเมลบนคอมพิวเตอร์จะได้เห็นทั้งสองทาง
...
- แผนฟรีของ Supabase ส่งอีเมลได้จำกัดต่อชั่วโมง ถ้าจะใช้งานจริงควรต่อ SMTP ของตัวเอง
  ที่ **Authentication → SMTP Settings**
